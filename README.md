<p align="center">
  <a href="https://github.com/ishandutta2007/Awesome-Insurance-Rating-Engine">
    <img src="assets/banner.svg" alt="Awesome Insurance Rating Engine Banner" width="100%">
  </a>
</p>
...
<p align="center">
  ...
  <a href="https://github.com/ishandutta2007/Awesome-Insurance-Rating-Engine/stargazers"><img src="https://img.shields.io/github/stars/ishandutta2007/Awesome-Insurance-Rating-Engine?style=flat-square" alt="Stars"/></a>
  <a href="https://github.com/ishandutta2007/Awesome-Insurance-Rating-Engine/network/members"><img src="https://img.shields.io/github/forks/ishandutta2007/Awesome-Insurance-Rating-Engine?style=flat-square" alt="Forks"/></a>
  <a href="https://github.com/ishandutta2007/Awesome-Insurance-Rating-Engine/issues"><img src="https://img.shields.io/github/issues/ishandutta2007/Awesome-Insurance-Rating-Engine?style=flat-square" alt="Issues"/></a>
  <a href="https://github.com/ishandutta2007/Awesome-Insurance-Rating-Engine/blob/main/LICENSE"><img src="https://img.shields.io/github/license/ishandutta2007/Awesome-Insurance-Rating-Engine?style=flat-square" alt="License"/></a>
...
| **[nemmons/aspire](https://github.com/nemmons/aspire)** | [![Stars](https://img.shields.io/github/stars/nemmons/aspire?style=social&color=white)](https://github.com/nemmons/aspire/stargazers) | Python 🐍 | Flexible Python-based insurance rating engine for defining custom rating algorithms, factor tables, and premium calculation workflows. |
| **[gs-actuary/ratingtables](https://github.com/gs-actuary/ratingtables)** | [![Stars](https://img.shields.io/github/stars/gs-actuary/ratingtables?style=social&color=white)](https://github.com/gs-actuary/ratingtables/stargazers) | R 📦 | Table-driven insurance rating engine for R. Executes ordered rating specifications, supports caps, rounding, coverage plans, and complete audit tracing. |
| **[Burning Cost](https://github.com/burningcost/shap-relativities)** | [![Stars](https://img.shields.io/github/stars/burningcost/shap-relativities?style=social&color=white)](https://github.com/burningcost/shap-relativities/stargazers) | Python 🐍 | Suite of open-source Python tools for personal lines pricing. Converts GBM models (CatBoost/XGBoost) into GLM-compatible multiplicative rating factor tables via SHAP. |
| **[WattyAI/actuaflow](https://github.com/WattyAI/actuaflow)** | [![Stars](https://img.shields.io/github/stars/WattyAI/actuaflow?style=social&color=white)](https://github.com/WattyAI/actuaflow/stargazers) | Python 🐍 | End-to-end Python framework for actuarial pricing, implementing frequency-severity GLM modeling and automated tariff class generation. |
| **[imanebosch/acturate](https://github.com/imanebosch/acturate)** | [![Stars](https://img.shields.io/github/stars/imanebosch/acturate?style=social&color=white)](https://github.com/imanebosch/acturate/stargazers) | Python 🐍 | Lightweight open-source actuarial rating engine for executing custom rating formulas and actuarial factor table lookups. |
| **[ACTUS Insurance Core](https://github.com/actusfrf/actus-solidity)** | [![Stars](https://img.shields.io/github/stars/actusfrf/actus-solidity?style=social&color=white)](https://github.com/actusfrf/actus-solidity/stargazers) | .NET / C# 🔷 | Algorithmic Contract Types Unified Standards (ACTUS) engine implementation for insurance contract modeling, premium payment schedules, and state transitions. |
| **[Premium Calculation Engine](https://github.com/topics/insurance-rating)** | [![Stars](https://img.shields.io/github/stars/topics/insurance-rating?style=social&color=white)](https://github.com/topics/insurance-rating/stargazers) | .NET / C# 🔷 | Modular .NET framework supporting defined-benefit, defined-contribution, and multi-factor rating algorithms for life and health insurance products. |
...
[![Star History Chart](https://star-history.dera.page/svg?repos=ishandutta2007/Awesome-Insurance-Rating-Engine&type=date&legend=top-left)](https://star-history.dera.page/#ishandutta2007/Awesome-Insurance-Rating-Engine&type=date&legend=top-left)
